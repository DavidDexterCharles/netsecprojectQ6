...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/js/bootstrap.min.js" integrity="sha384-vBWWzlZJ8ea9aCX4pEW3rVHjgjt7zpkNpZk+02D9phzyeVkE+jo0ieGizqPLForn" crossorigin="anonymous"></script>
    ...
    <body>
        ...
        <div class="row">
          <h1 class="col-md-4">SQL Injection Demo:</I></h1>
          <p>Use :  <code>hack'or '1'='1</code> as the password to perform SQL Injection</p>
        </div>
        <div class="container-fluid jumbotron" id=outer>
          <img class="col-md-5" src="i1.PNG" alt="DEMO">
            <form class="col-md-2" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
              ...
              <a href="https://sqlinjection-ice-wolf.c9users.io/netsecprojectQ6/demofix.php">DEMO FIX HERE</a>
            </form>
             <img  class="col-md-5" src="i2.PNG" alt="DEMO">
        </div>
